...
GPIO.setmode(GPIO.BCM) #specifies that we are using the GPIO pin numbering weve seen on diagrams in class

# Setup GPIO pins for PWM control
...
base_speed = 8.03 # car moves forward slowly
speed_change = 0.001
...
# Filter and average left and right lane lines
